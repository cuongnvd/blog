...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="{{route('trangchu')}}" class="nav-link">Visit Website</a>
      </li>
    </ul>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{route('index')}}" class="brand-link">
      <img src="https://storage.googleapis.com/cdn.nhanh.vn/store/25088/store_1584590640_524.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{route('themeadd')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>THÊM CHỦ ĐỀ</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{route('themelist')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{route('newsadd')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>THÊM TIN TỨC</p>
                </a>
              </li>
  ...
  <div class="content-wrapper">
    ...
    <!-- Main content -->
         ...
         <section class="content" style="margin-left: 5%">
          ...
          <form action="{{URL::to('addnews')}}" method="post" enctype="multipart/form-data"> 
                    {{ csrf_field()}}
          <div class="row">
            <div class="col-md-6">
            ...
            @endif  
                  ...
                  <div class="form-group">
                    <label for="inputName">NGÀY GỬI</label>
                  ...
                  <div class="form-group">
                    <label for="inputName">LOẠI CHỦ ĐỀ</label>
                    <div class="form-group">
                    
                      <select class="form-control select2" name="theme_id" style="width: 100%;">
